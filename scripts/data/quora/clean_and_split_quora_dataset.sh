...
python clean_quora_dataset.py ../../../data/raw/train.csv ../../../data/interim/quora/
python clean_quora_dataset.py ../../../data/raw/test.csv ../../../data/interim/quora/
...
python split_quora_file.py 0.1 ../../../data/interim/quora/train_cleaned.csv ../../../data/processed/quora/
